...
public class JmixGroupGridMenuItemActionWrapper<T> extends Composite<Div>
    ...
    protected JmixGroupGridMenuItemActionSupport actionSupport;

    public JmixGroupGridMenuItemActionWrapper() {
    }

    public JmixGroupGridMenuItemActionWrapper(GridMenuItem<T> menuItem) {
    ...
    public JmixGroupGridMenuItemActionSupport getActionSupport() {
    ...
    protected JmixGroupGridMenuItemActionSupport createActionSupport() {
        return new JmixGroupGridMenuItemActionSupport(this);
    }
