...
public class JmixGroupGridMenuItemActionSupport {

    protected final JmixGroupGridMenuItemActionWrapper<?> menuItem;
    ...
    public JmixGroupGridMenuItemActionSupport(JmixGroupGridMenuItemActionWrapper<?> menuItem) {
