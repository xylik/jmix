...
import io.jmix.groupgridflowui.kit.vaadin.grid.contextmenu.GridSubMenu;
import io.jmix.groupgridflowui.kit.vaadin.grid.dnd.GridDropMode;
...
public abstract class AbstractGroupGridLoader<T extends Grid<?> & EnhancedGroupDataGrid<?> & HasActions>
    ...
    protected void loadMultiSort() {
        boolean multiSort = loadBoolean(element, "multiSort")
                .orElse(false);
        MultiSortPriority multiSortPriority = loadEnum(element, MultiSortPriority.class, "multiSortPriority")
                .orElse(MultiSortPriority.PREPEND);
    ...
    protected void loadEditorActionsColumn(T resultComponent, Element columnElement) {
        ...
        Column<?> editColumn = createEditColumn(resultComponent, columnElement, editor);
    ...
    protected void loadContextMenu() {
        ...
        JmixGroupGridContextMenu<?> contextMenu = resultComponent.getContextMenu();
    ...
    protected void addContextMenuItem(Function<Component, GridMenuItem<?>> menuItemGenerator,
        ...
        switch (childElement.getName()) {
            case "item":
                GroupDataGridContextMenuItemComponent<?> component = new GroupDataGridContextMenuItemComponent<>();
    ...
    protected void loadContextMenuItem(GroupDataGridContextMenuItemComponent<?> component,
    ...
    protected void loadContextMenuItemAction(GroupDataGridContextMenuItemComponent<?> component, Element element) {
