...
public interface GroupDataGridEditor<T> extends Editor<T> {
     ...
     * @see #initColumnDefaultEditorComponent(Column, String)
     * @see #setColumnEditorComponent(Column, String, Function)
     */
     ...
     * @see #setColumnEditorComponent(Column, String, Function)
     */
    void initColumnDefaultEditorComponent(Column<T> column, String property);
     ...
     * @see #initColumnDefaultEditorComponent(Column, String)
     */
    void setColumnEditorComponent(Column<T> column, String property,
                                  Function<EditComponentGenerationContext<T>, Component> generator);
