...
package io.jmix.groupgridflowui.component.editor;
...
import io.jmix.groupgridflowui.kit.vaadin.grid.Grid.AbstractGridExtension;
import io.jmix.groupgridflowui.kit.vaadin.grid.Grid.Column;
import io.jmix.groupgridflowui.kit.vaadin.grid.ItemClickEvent;
import io.jmix.groupgridflowui.kit.vaadin.grid.editor.*;
...
public class DataGridEditorImpl<T> extends AbstractGridExtension<T>
    ...
    public void setColumnEditorComponent(String property,
        ...
        if (getGrid() instanceof EnhancedGroupDataGrid<?> enhancedDataGrid) {
            MetaPropertyPath metaPropertyPath =
                    getMetadataTools().resolveMetaPropertyPath(getEntityMetaClass(), property);

            Column<T> column = (Column<T>) enhancedDataGrid.getColumnByMetaPropertyPath(metaPropertyPath);
    ...
    @Override
    public void initColumnDefaultEditorComponent(Column<T> column, String property) {
        setColumnEditorComponent(column, property, new DefaultEditComponentGenerator(property));
    }

    @Override
    public void setColumnEditorComponent(Column<T> column, String property,
                                         Function<EditComponentGenerationContext<T>, Component> generator) {
        Preconditions.checkNotNullArgument(column);
    ...
    protected void registerEditComponent(Column<T> column, Component editComponent) {
